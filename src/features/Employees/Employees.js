...
export const updateDeveloperListAction = createAsyncThunk(
  "users/updateDeveloperListAction",
  async (updateData) => {
    const response = await updateDeveloperListApi(updateData.id, updateData);
    console.log(response.data);
    return response.data
  }
);
...
export const employeeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(updateDeveloperListAction.pending, (state) => {
      state.updateEmployeeStatus = "loading";
    });
